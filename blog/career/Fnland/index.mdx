---
title: 'Fnland, FnC, and FnIde'
date: '2025-01-17'
slug: 'fnland'
category: 'career'
tags: 'Rust, Compiler, IDE'
...
---
This project was built by 3 ECE Master's students collaboratively to apply their knowledge of Rust to the design of a new programming language Fnland, FnC (Fnland Compiler), and FnIde (Fnland IDE).
